...
|---------------------------|----------------------------------------------------|------------|-------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| Subjective                | Uses [Health Information Exchange (HIE)](HIE.html) |            | Views [Patient Care](StructureDefinition-PatientCare.html)                                      | Creates  [Observation](StructureDefinition-Observation.html)                                                                                                           |                     |
| Objective                 |                                                    |            | May use templates to capture data, see assessment in [clinical-process](#nursing-process-adpie) | Creates  [Observation](StructureDefinition-Observation.html)                                                                                                           |                     | 
| Assessment                |                                                    |            |                                                                                                 | Creates  [Condition](StructureDefinition-Condition.html)                                                                                                               |                     |
| Plan                      |                                                    |            | [Referral Letter](Questionnaire-PatientReferral.html)                                           | [ServiceRequest](StructureDefinition-Condition.html) <br/> [MedicationRequest](StructureDefinition-MedicationRequest.html) <br/> [Task](StructureDefinition-Task.html) | See Order from [clinical-process](#nursing-process-adpie)    |
